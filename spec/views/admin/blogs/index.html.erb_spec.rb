...
describe "/admin/blogs/index.html.erb" do
  ...
  before(:each) do
    ...
    blog_98.should_receive(:posts).and_return([])    
    ...
    blog_98.should_receive(:uploads).and_return([]) 
    blog_98.should_receive(:title).and_return("MyString")
    blog_98.should_receive(:short_name).and_return("MyString")
    blog_98.should_receive(:creator).at_least(1).times.and_return(nil)
    blog_99 = mock_model(Blog)                    
    blog_99.should_receive(:posts).and_return([]) 
    ...
    blog_99.should_receive(:creator).at_least(1).times.and_return(@user)
    blog_99.should_receive(:uploads).and_return([]) 
