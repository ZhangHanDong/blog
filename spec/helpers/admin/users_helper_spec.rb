...
describe Admin::UsersHelper do
  ...
  describe "link_to_user" do
    ...
    it "should link to the given user" do
      should_receive(:admin_user_path).at_least(:once).and_return('/admin/users/1')
      link_to_user(@user).should have_tag("a[href='/admin/users/1']")
    end
  ...
  describe "link_to_current_user, When logged in" do
    ...
    it "should link to the given user" do
      should_receive(:admin_user_path).at_least(:once).and_return('/admin/users/1')
      link_to_current_user().should have_tag("a[href='/admin/users/1']")
    end
