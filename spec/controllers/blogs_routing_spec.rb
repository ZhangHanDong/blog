...
describe BlogsController do
  ...
  describe "route generation" do
    ...
    it "should map { :controller => 'blogs', :action => 'index', :page => '10' } to /blogs/page/10" do
      route_for(:controller => "blogs", :action => "index", :page => "10").should == "/blogs/page/10"
    end
  ...
  describe "route recognition" do
    ...
    it "should generate params { :controller => 'blogs', action => 'index', :page => '10' } \ 
        from GET /blogs/page/10" do
      params_from(:get, "/blogs/page/10").should == {:controller => "blogs", :action => "index", :page => "10"}
    end

    it "should generate params { :controller => 'blogs', action => 'show', id => '1' } \ 
        from GET /blogs/1" do
      params_from(:get, "/blogs/1").should == {:controller => "posts", :action => "index", :blog_id => "1"}
    end
