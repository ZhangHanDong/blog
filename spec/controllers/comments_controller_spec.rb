...
describe CommentsController do
  ...
  describe "handling GET /blogs/1/comments" do
    ...
    it "should be successful, render index template and assign blog and comments for the view" do
  ...
  describe "handling POST /blogs/1/posts/1/comments" do
    ...
    describe "with assigning post to comment (and sucessful save)" do
      ...
      it "should set comment user to current_user if there is a user logged in" do
        login_as :quentin
        stub!(:reset_session)
  ...
  describe "handling GET /blogs/1/posts/1/comments/1" do
