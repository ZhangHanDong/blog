...
describe Admin::PostsController do
  ...
  describe "route generation" do
    ...
    it "should map { :controller => 'admin/posts', :action => 'index', :blog_id => '1', \
        :page => '10' } to /admin/blogs/1/posts/page/10" do
      route_for(:controller => "admin/posts", :action => "index",
                :blog_id => "1", :page => "10").should == "/admin/blogs/1/posts/page/10"
    end

    it "should map { :controller => 'admin/posts', :action => 'index', :user_id => '1' }, \
        :page => '10' } to /admin/users/1/posts/page/10" do
      route_for(:controller => "admin/posts", :action => "index",
                :user_id => "1", :page => "10").should == "/admin/users/1/posts/page/10"
    end

    it "should map { :controller => 'admin/posts', :action => 'index', :tag_id => '1', \
        :blog_id => '1', :page => '10' } to /admin/blogs/1/tags/1/posts/page/10" do
      route_for(:controller => "admin/posts", :action => "index", :tag_id => "1",
                :blog_id => "1", :page => "10").should == "/admin/blogs/1/tags/1/posts/page/10"
    end

    it "should map { :controller => 'admin/posts', :action => 'index', :user_id => '1', \
        :blog_id => '1', :page => '10' } to /admin/blogs/1/users/1/posts/page/10" do
      route_for(:controller => "admin/posts", :action => "index", :user_id => "1",
                :blog_id => "1", :page => "10").should == "/admin/blogs/1/users/1/posts/page/10"
    end
  ...
  describe "route recognition" do
    ...
    it "should generate params { :controller => 'admin/posts', action => 'index', :blog_id => '1', \
        :page => '10' } from GET /admin/blogs/1/posts/page/10" do
      params_from(:get, "/admin/blogs/1/posts/page/10").should == { :controller => "admin/posts",
                                                                    :action => "index",
                                                                    :page => "10",
                                                                    :blog_id => "1" }
    end

    it "should generate params { :controller => 'admin/posts', action => 'index', :page => '10' }  \
        from GET /admin/users/1/posts/page/10" do
      params_from(:get, "/admin/users/1/posts/page/10").should == { :controller => "admin/posts",
                                                                    :action => "index",
                                                                    :page => "10",
                                                                    :user_id => "1" }
    end
    ...
    it "should generate params { :controller => 'admin/posts', action => 'index', :blog_id => '1', \
        :user_id => '1', :page => '10' } from GET /admin/blogs/1/users/1/posts/page/10" do
      params_from(:get, "/admin/blogs/1/users/1/posts/page/10").should == { :controller => "admin/posts",
                                                                            :action => "index",
                                                                            :blog_id => "1",
                                                                            :page => "10",
                                                                            :user_id => "1" }
    ...
    it "should generate params { :controller => 'admin/posts', action => 'index', :blog_id => '1', \
        :tag_id => '1', :page => '10' } from GET /admin/blogs/1/tags/1/posts/page/10" do
      params_from(:get, "/admin/blogs/1/tags/1/posts/page/10").should == { :controller => "admin/posts",
                                                                           :action => "index",
                                                                           :blog_id => "1",
                                                                           :page => "10",
                                                                           :tag_id => "1" }
